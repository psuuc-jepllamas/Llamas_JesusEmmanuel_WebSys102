...
{
    public function compute($operation1, $val1, $val2, $operation2, $val3, $val4)//dito ilalagay ang baryabol ng operasyon at ng dalawang numero
    {
        ...
        echo "<p>Value 1: $val3</p>";//dito ipapakita ang unang numero na galing sa calculate na punsiyon
        echo "<p>Value 2: $val4</p>";//dito ipapakita ang pangalawang numero na galing sa calculate na punsiyon
        echo "<p>Operator: $operation2</p>";//ipapakita ang ginamit na operasyon
        echo "<p>Result: <span style='display: inline-block; padding: 10px; border-radius: 5px; color:white; background-color:" . ($result2 % 2 == 0 ? 'green' : 'blue') . "'> $result2</span></p>";//dito ipapakita ang resulta sa dalawang numero na ginamitan ng operasyon, at dito rin magdedesisyon na magpapalit ng kulay ng background kung ang resulta ba ay pantay o kakaiba
